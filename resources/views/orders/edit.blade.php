    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('orders.update', $order) }}">
            ...
            <div>
                ...
                <x-text-input id="order_date" name="order_date" type="text" class="mt-1 block w-full" :value="old('order_date', $order->order_date)"
            ...
            <div>
                ...
                <x-text-input id="order_status" name="order_status" type="text" class="mt-1 block w-full" :value="old('order_status', $order->order_status)"
            ...
            <div class="mt-2">
                ...
                <x-text-input id="seats" name="seats" type="number" class="mt-1 block w-full"
                    :value="old('seats', $order->seats)" required autofocus autocomplete="off" />
                <x-input-error class="mt-2" :messages="$errors->get('seats')" />
            </div>

            <div>
                <x-input-label for="category" :value="__('Category')" />
                <x-text-input id="category" name="category" type="text" class="mt-1 block w-full" :value="old('category', $order->category)"
            ...
            <div>
                ...
                <x-text-input id="category_price" name="category_price" type="text" class="mt-1 block w-full" :value="old('category_price', $order->category_price)"
            ...
            <div>
                ...
                <x-text-input id="total_price" name="total_price" type="text" class="mt-1 block w-full" :value="old('total_price', $order->total_price)"
