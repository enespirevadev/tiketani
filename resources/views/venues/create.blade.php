    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('venues.store') }}">
            ...
            <div>
                ...
                <textarea name="description" placeholder="{{ __('Enter your Venue description here ...') }}"
            ...
            <div>
                ...
                <x-text-input id="seats" name="seats" type="text" class="mt-1 block w-full" :value="old('seats', '')"
