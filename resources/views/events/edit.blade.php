        ...
        <form method="POST" action="{{ route('events.update', $event) }}">
            ...
            <div class="mt-2">
                ...
                <textarea name="description" placeholder="{{ __('Enter your Event description here ...') }}"
                    class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">{{ old('description', $event->description) }}</textarea>
            ...
            <div class="mt-2">
                ...
                <div id="start-datetimepicker" class="relative mb-3 datetimepicker" data-te-date-timepicker-init
                    ...
                    <x-text-input type="text" name="start" id="form-event-start"
                        ...
                        :value="old('start', $event->start)" required autofocus autocomplete="off" />
            ...
            <div class="mt-2">
                ...
                <div id="end-datetimepicker" class="relative mb-3 datetimepicker" data-te-date-timepicker-init
                    ...
                    <x-text-input type="text" name="end" id="form-event-end"
                        class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                        :value="old('end', $event->end)" required autofocus autocomplete="off" />
            ...
            <div class="mt-2">
                ...
                <select name="tournament_id" data-te-select-init>
                    @foreach ($tournaments as $tournament)
                        <option value="{{ $tournament->id }}" @selected($event->tournament_id === $tournament->id)>
                            {{ $tournament->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mt-2">
                ...
                <x-text-input id="available_seats" name="available_seats" type="number" class="mt-1 block w-full"
                    :value="old('available_seats', $event->available_seats)" required autofocus autocomplete="off" />
            ...
            <div class="mt-2">
                ...
                <select name="teamA_id" data-te-select-init>
                    @foreach ($teams as $teamA)
                        <option value="{{ $teamA->id }}" @selected($event->teamA_id === $teamA->id)>
                            {{ $teamA->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mt-2">
                ...
                <select name="teamB_id" data-te-select-init>
                    @foreach ($teams as $teamB)
                        <option value="{{ $teamB->id }}" @selected($event->teamB_id === $teamB->id)>
                            {{ $teamB->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mt-2">
                ...
                <x-text-input id="categoryA_price" name="categoryA_price" type="number" class="mt-1 block w-full"
                    :value="old('categoryA_price', $event->categoryA_price)" required autofocus autocomplete="off" />
            ...
            <div class="mt-2">
                ...
                <x-text-input id="categoryB_price" name="categoryB_price" type="number" class="mt-1 block w-full"
                    :value="old('categoryB_price', $event->categoryB_price)" required autofocus autocomplete="off" />
            ...
            <div class="mt-2">
                ...
                <x-text-input id="categoryC_price" name="categoryC_price" type="number" class="mt-1 block w-full"
                    :value="old('categoryC_price', $event->categoryC_price)" required autofocus autocomplete="off" />
            ...
            <div class="mt-2">
                ...
                <x-text-input id="categoryD_price" name="categoryD_price" type="number" class="mt-1 block w-full"
                    :value="old('categoryD_price', $event->categoryD_price)" required autofocus autocomplete="off" />
