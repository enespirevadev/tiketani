    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('events.store') }}">
            ...
            <div class="mt-2">
                ...
                <div id="start-datetimepicker"
                    class="relative mb-3 datetimepicker" 
            ...
            <div class="mt-2">
                ...
                <x-text-input id="available_seats" name="available_seats" type="number" class="mt-1 block w-full" :value="old('available_seats', '')"
            ...
            <div class="mt-2">
                ...
                <x-text-input id="categoryA_price" name="categoryA_price" type="number" class="mt-1 block w-full" :value="old('categoryA_price', '')"
                    required autofocus autocomplete="off" />
            ...
            <div class="mt-2">
                ...
                <x-text-input id="categoryB_price" name="categoryB_price" type="number" class="mt-1 block w-full" :value="old('categoryB_price', '')"
                    required autofocus autocomplete="off" />
            ...
            <div class="mt-2">
                ...
                <x-text-input id="categoryC_price" name="categoryC_price" type="number" class="mt-1 block w-full" :value="old('categoryC_price', '')"
                    required autofocus autocomplete="off" />
            ...
            <div class="mt-2">
                ...
                <x-text-input id="categoryD_price" name="categoryD_price" type="number" class="mt-1 block w-full" :value="old('categoryD_price', '')"
                    required autofocus autocomplete="off" />
